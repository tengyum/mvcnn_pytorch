...
class ModelNetTrainer(object):
    ...
    def __init__(self, model, train_loader, val_loader, optimizer, loss_fn, model_name, log_dir, num_views=12):
        ...
        for epoch in range(n_epochs):
            ...
            for i, data in enumerate(self.train_loader):
                ...
                if self.model_name == 'mvcnn':
                    N, V, C, H, W = data[0].unsqueeze(2).size()
                    in_data = Variable(data[0]).view(-1, C, H, W).cuda()
            ...
            if val_overall_acc > best_acc:
                ...
                self.max_acc = max(self.max_acc, best_acc)
